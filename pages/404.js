        ...
        <div className="container">
          <div className="error-page-content text-center">
            ...
            <div className="btn-social pt-15 wow fadeInUp delay-0-4s">
              <Link legacyBehavior href="/">
                <a className="theme-btn mb-30 mx-2 text-white">
                  Go to Home <i className="fas fa-long-arrow-right" />
                </a>
              </Link>
              <div className="social-style-two mb-30 mx-2">
                <a target="_blank" href="https://web.facebook.com/petafive">
                  <i className="fab fa-facebook-f" />
                </a>
                <a target="_blank" href="https://twitter.com/petafive">
                  <i className="fab fa-twitter" />
                </a>
                <a target="_blank" href="https://www.instagram.com/petafive/">
